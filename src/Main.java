...
public class Main extends JFrame implements ActionListener {
    ...
    Main()
    {
        ...
        t1.setFont(new Font("Algerian",Font.PLAIN,12));
        t1.setMnemonic('N');
        ...
        t3.setFont(new Font("Algerian",Font.PLAIN,12));
        t3.setMnemonic('S');
        ...
        t4.setFont(new Font("Algerian",Font.PLAIN,12));
        t4.setMnemonic('L');
        ...
        s1.setFont(new Font("Algerian",Font.PLAIN,12));
        s1.setMnemonic('U');
        ...
        s2.setFont(new Font("Algerian",Font.PLAIN,12));
        s2.setMnemonic('p');
        ...
        s3.setFont(new Font("Algerian",Font.PLAIN,12));
        s3.setMnemonic('T');
        ...
        p1.setFont(new Font("Algerian",Font.PLAIN,12));
        p1.setMnemonic('P');
        ...
        p2.setFont(new Font("Algerian",Font.PLAIN,12));
        p2.setMnemonic('L');
      ...
      JMenu util =new JMenu("Utilities");
        ...
        u1.setFont(new Font("Algerian",Font.PLAIN,12));
        u1.setMnemonic('o');
        ...
        u2.setFont(new Font("Algerian",Font.PLAIN,12));
        u2.setMnemonic('C');
        ...
        u3.setFont(new Font("Algerian",Font.PLAIN,12));
        u3.setMnemonic('E');
        ...
        m8.add(m8i1);
        m8i1.setForeground((Color.red));
        m8i1.setFont(new Font("Algerian", Font.PLAIN, 14));
        m8i1.setMnemonic('X');
